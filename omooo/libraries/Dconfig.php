...
class Dconfig {
	...
	public function file($file) {
		...
		'/**'.PHP_EOL.
		' * Omweb Website Management System'.PHP_EOL.
		' * '.PHP_EOL.
		' * @since			version '.DR_VERSION.PHP_EOL.
		' * @author			Omooo <kefu@omooo.com>'.PHP_EOL.
		' * @license     	http://www.omooo.com/license'.PHP_EOL.
		' * @copyright		Copyright (c) 2011 - 9999, Omooo.Com, Inc.'.PHP_EOL.
		' */'.PHP_EOL.PHP_EOL
		;
		return $this;
	}
