...
class Form extends M_Controller {
    ...
    public function listshow() {
        ...
        $this->template->display('form_listshow.html');
    }
    ...
    public function toform() {
		...
		if (!$data) {
            exit('<div style="color:red;padding:20px;">'.lang('247').'<br>&nbsp;</div>');
        }
		
		$string = '<link href="'.SITE_URL.'omooo/statics/css/table_form.css" rel="stylesheet" type="text/css" />'.PHP_EOL;
