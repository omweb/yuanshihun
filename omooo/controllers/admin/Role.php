 ...
 * @filesource	svn://www.omooo.com/v2/omooo/controllers/admin/role.php
 */
...
class Role extends M_Controller {
	...
	public function auth() {
		...
		$id = (int)$this->input->get('id');
		if ($id == 1) {
            $this->admin_msg(lang('027'));
        }
		
		if (IS_POST) {
            $this->auth_model->update_auth($id, 'system', $this->input->post('data', TRUE));
        }
