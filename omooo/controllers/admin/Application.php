...
$url = 'http://store.omooo.com/index.php?c=category&id=1&action=application&param='.dr_base64_encode(dr_array2string(array(
			'site' => SITE_URL,
			'name' => SITE_NAME,
			'data' => $data,
			'admin' => SELF,
    ...
    public function update() {
		...
		$url = 'http://store.omooo.com/index.php?c=down&m=update&action=application&param='.dr_base64_encode(dr_array2string(array(
			'site' => SITE_URL,
			'name' => SITE_NAME,
			'data' => array(
				'id' => $key,
