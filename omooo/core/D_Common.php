...
class D_Common extends CI_Controller {
    ...
    private function _init_variable() {
        ...
        define('HOME_THEME_PATH', SITE_URL.'omooo/statics/'.SITE_THEME.'/');
        define('HOME_MOBILE_PATH', SITE_URL.'omooo/mobiles/'.SITE_THEME.'/');
    ...
    public function goto_404_page($msg) {
        ...
        $root = FCPATH.'omooo/'.($this->template->mobile ? 'mobiles' : 'templates').'/'.SITE_TEMPLATE.'/404.html';
    ...
    public function s404() {
        $this->goto_404_page('OmWeb无法找到对应的页面('.DR_URI.'),可能您没有配置好路由规则');
    }
}
